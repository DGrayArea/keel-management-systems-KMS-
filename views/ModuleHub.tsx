...
const recentLogs = [
  ...
  { dot: 'coral' as const, text: 'Item #034 — Low stock warning', time: '9:05 AM', module: 'Inventory' },
  { dot: 'green' as const, text: 'Employee Fatima Kolo — Leave approved', time: '8:40 AM', module: 'HR' },
];
...
export default function ModuleHub() {
  ...
  return (
    <div className="max-w-5xl">
      <PageHeader
        title="Module Hub"
        description="Select a module to manage, or view system-wide activity below."
      />
